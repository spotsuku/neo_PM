...
- description_long : 2〜4文で WHY/WHO/WHAT の核が掴め、応募者が「自分ごと化」できるか。タイトルと整合し、概要だけで応募動機が湧くか。
...
- pain : 理想と現場のギャップを「事実」で記述しているか (問題=事実のズレ、課題=問題を要因分析して導いた取り組むべきこと、と混同しない)。憶測・一般論・「不便だと思う」は減点。事実かどうかが鍵。

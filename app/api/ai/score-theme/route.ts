...
採点基準 (各項目共通 / 0〜100):
- 100 = 応募者が確信を持って動ける、完成度の高い記述
- 70  = 安心して公開できる水準。要点が揃い、説得力がある
- 50  = 公開できる最低水準。骨格があり方向性が伝わる (申請ゲートはここ)
- 30  = 1〜2 要素しか書けておらず、方向性が掴みづらい
- 0   = 未記入 / 内容が無い

重要:
- 点数は必ず 5 点刻み (0,5,10,...,100) で付けること。
- WHAT(提供価値) がプロダクト説明になっていたら減点 (本来は『相手が得る変化』)。
- テーマ出題は応募者のアイデアの余地を残すことが価値。過度に具体化されていなくても、方向性・問い・制約が明確であれば高得点を付けてよい (アイデアの幅を狭めるほど具体化していることをもって加点しない)。

...
export function ThumbnailEditor({
  ...
  return (
    <>
      ...
      {open && (
        <div
          className="fixed inset-0 z-50 bg-ink/40 backdrop-blur grid place-items-center p-4"
          onClick={close}
        >
          <div
            className="glass-strong w-full max-w-md rounded-2xl p-5 animate-risein"
          ...
          >
            ...
            {/* URL 入力 */}
            <div className="mb-3">
              <span className="t-label block mb-1.5">または URL を貼り付け</span>
              <input
                type="url"
                value={url}
